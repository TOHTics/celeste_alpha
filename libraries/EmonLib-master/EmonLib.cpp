...
int EnergyMonitor::analogRead2(unsigned int pin)
{
  analogRead(inPinV);//Dummy read
    delay(2);
    return (analogRead(inPinV));
...
//--------------------------------------------------------------------------------------
void EnergyMonitor::calcVI(unsigned int crossings, unsigned int timeout, bool *timeOutFlag)
{
  #if defined emonTxV3
